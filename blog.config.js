...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.lvy.life', // 网站地址
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://s4.zstatic.net/npm/prismjs@1.29.0/themes/prism-okaidia.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://s4.zstatic.net/npm/prismjs@1.29.0/themes/prism-solarizedlight.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://s4.zstatic.net/npm/prismjs@1.29.0/themes/prism-okaidia.min.css', // 深色模式主题
  ...
  WIDGET_PET_LINK:
    ...
    'https://s4.zstatic.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://s4.zstatic.net/npm/twikoo@1.6.17/dist/twikoo.all.min.js', // twikoo客户端cdn
  ...
  COMMENT_GITALK_JS_CDN_URL:
    ...
    'https://s4.zstatic.net/npm/gitalk@1/dist/gitalk.min.js', // gitalk客户端 js cdn
  COMMENT_GITALK_CSS_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CSS_CDN_URL ||
    'https://s4.zstatic.net/npm/gitalk@1/dist/gitalk.css', // gitalk客户端 css cdn
